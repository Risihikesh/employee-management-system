    ...
    return (
        <div style={{ display: "flex", justifyContent: "center", height: "100vh" }} >
            <div >
                ...
                <span> <Grid style={{ fontFamily: "Montserrat", fontSize: "15px", fontWeight: "500px" }} item xs={12}>
                <label style={{ fontFamily: "Montserrat", fontSize: "15px", fontWeight: "500px" }} htmlFor="Date of Birth">Pick a date</label>
                ...
                <TextField
                    ...
                    InputProps={{
                        style: {
                            backgroundColor: 'rgba(37, 64, 109, 1)',
                        },
                    }}
                />
            </Grid></span>
